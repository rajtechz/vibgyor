...
const TestMatchFrameIcon = ({ width = 350, height = 470, style }) => (
  <Svg width={width} height={height} viewBox="0 0 469 666" style={style} fill="none">
    ...
    <G>
      <Circle cx="165.999" cy="213" r="25" transform="rotate(-13.3729 165.999 213)" fill="#34F07F"/>
    </G>
    <G>
      <Path d="M166.254 222.166C159.022 218.289 154.868 216.236 154.125 212.173C153.537 208.955 155.764 206.821 155.811 206.764C159.326 203.147 163.568 205.169 164.608 205.928C165.26 204.778 168.325 201.076 172.82 202.664C173.475 202.893 175.667 203.852 176.406 206.469C177.676 211.006 173.427 215.95 169.232 221.469C168.88 221.938 168.377 222.238 167.84 222.366C167.314 222.491 166.751 222.432 166.254 222.166Z" fill="white"/>
    </G>
    
    {/* Large Red Heart with white checkmark */}
    <G>
      <Path d="M259.198 450.789C235.876 436.286 222.442 428.534 220.832 414.804C219.559 403.929 227.455 397.277 227.625 397.099C240.144 385.773 253.877 393.436 257.189 396.194C259.613 392.494 270.646 380.787 285.321 387.056C287.458 387.961 294.576 391.638 296.482 400.537C299.749 415.964 284.493 431.567 269.297 449.102C268.018 450.59 266.274 451.485 264.452 451.797C262.669 452.101 260.803 451.785 259.198 450.789Z" fill="#F64A69"/>
    </G>
    <G>
      <Path d="M248.868 417.242L256.147 423.739L267.725 408.57" stroke="white" strokeWidth="5.54713" strokeLinecap="round"/>
    </G>
    <G>
...
export default TestMatchFrameIcon;
